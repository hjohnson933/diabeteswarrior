...
def index():
    ...
    return render_template("bgl/index.html", posts=posts)
...
def create():
    ...
    if request.method == "POST":
        ...
        if error is not None:
            ...
            db.commit()
            return redirect(url_for("bgl.index"))

    return render_template("bgl/create.html")
...
def update(id):
    ...
    return render_template("bgl/update.html", post=post)
